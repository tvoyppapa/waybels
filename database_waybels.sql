-- ===============================================
-- База данных WayBels - Платформа репетиторов
-- ===============================================

CREATE DATABASE IF NOT EXISTS waybels_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE waybels_db;
...
('Иван Петров', 'test@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'ivan_petrov', 'programming', 'user', TRUE, '/img/avatars/user1.jpg'),
('Анна Смирнова', 'anna@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'anna_teacher', 'languages', 'teacher', TRUE, '/img/avatars/teacher1.jpg'),
('Дмитрий Козлов', 'dmitry@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'dmitry_math', 'math', 'teacher', TRUE, '/img/avatars/teacher2.jpg'),
('Елена Волкова', 'elena@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'elena_design', 'design', 'teacher', TRUE, '/img/avatars/teacher3.jpg'),
('Сергей Новиков', 'sergey@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'sergey_code', 'programming', 'teacher', TRUE, '/img/avatars/teacher4.jpg'),
('Мария Иванова', 'maria@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'maria_music', 'music', 'teacher', TRUE, '/img/avatars/teacher5.jpg'),
('Админ', 'admin@waybels.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', NULL, 'admin', TRUE, '/img/avatars/admin.jpg');
